            ...
            <div class="container">
                <div class="row justify-content-center">
                    <?php for($x=0; $x<count($audioArray); $x++) { ?>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 py-2">
                            <a href="#" data-toggle="modal" data-target=<?php echo '#'.$audioArray[$x]["modalTarget"] ?>>
                                <div class="card px-4 pb-1 h-100 card-border-c rounded-0">
                                    <img class="card-img-top img-fluid card-img-wrap mx-auto" src=<?php echo $audioArray[$x]["image"] ?> alt="Card image cap">
                        ...
                        <!-- modals -->
                        <div class="modal fade" id=<?php echo $audioArray[$x]["modalTarget"] ?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content modal-style">
                                    <div class="modal-header modal-header-style">
                                        <h5 class="modal-title" id="exampleModalLabel"><?php echo $audioArray[$x]["title"] ?></h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 p-0">
                                                    <div class="modal-img-wrap">
                                                        <img class="modal-img" src=<?php echo $audioArray[$x]["image"] ?> alt="product image">
                                                    </div>
                                                </div>
