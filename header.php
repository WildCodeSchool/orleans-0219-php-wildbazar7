...
<header>
    ...
    <section class="container-fluid">
        <nav class="navbar navbar-expand-lg">
            ...
            <a class="navbar-brand color-navbar ml-3" href="index.php">Phone Bazar</a>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu nav-dropdown-style" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item color-navbar" href="phoneCase.php">Protections</a>
                                    <a class="dropdown-item color-navbar" href="audio.php">Audio & bluetooth</a>
                                    <a class="dropdown-item color-navbar" href="page_produit.php">Chargers & batteries</a>
                                    <a class="dropdown-item color-navbar" href="accessories.php">Accessories</a>
                                </div>
                            </li>
